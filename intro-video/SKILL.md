...
- **Camera:** probe the recording and its sidecar, render the automatic first cut, judge every framing on one tile of click-moment frames, correct the plan in a single pass, and re-render. Deliver the refined cut with the automatic one.
